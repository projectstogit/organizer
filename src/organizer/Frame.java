...
public class Frame {
    ...
    public static void getEvents (Integer days)
    {
        try {
            ...
            ArrayList<model.Event> events = (ArrayList<model.Event>)session.createQuery("from Event as event where login='"+Login.getLog+"'and date>='"
            ...
            {
                /*создаем обьект для каждой новой заметки и присваиваем необходимые характеристики*/
                area = new JTextPane();
